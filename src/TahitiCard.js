...
class TahitiCard extends BasicCard {
    ...
    async componentDidMount() {
        const address = await TahitiFaucet.methods.getManager().call();
        this.setState({manager: address});
        const playersCount = await TahitiFaucet.methods.getPlayersCount().call();
        const balance = await TahitiFaucet.methods.getBalance().call();
